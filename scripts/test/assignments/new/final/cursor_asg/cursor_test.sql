...
--!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
and pa.fk_pension_agreement = 23540831
--!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
*/
...
begin
  ...
  using (select l_po_id fk_pay_order, 'CONTRACT' filter_code, 23540831 filter_value from dual
        ) u
...
/
select t.*
from   table(pay_gfnpo_pkg.get_assignments_calc(pay_gfnpo_pkg.get_assignments_cur(&po_id, 'COMPOUND'))) t
