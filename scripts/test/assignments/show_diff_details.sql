...
and    doc.ref_kodinsz = 23145243
/
select *
from   pension_agreement_addendums pa
where  pa.fk_pension_agreement = 23145243
/
select *
from   fnd.sp_pen_dog doc
where  doc.ref_kodinsz = 23145243
/
select p.dop_pen
from   fnd.sp_fiz_lits p
where  p.ssylka = 297205 --9039,2 9065.04
/
select *
from   fnd.RZTB_ISTOR_OBYAZ	 io
where  io.ssylka = 297205
/
